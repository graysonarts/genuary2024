...
fn draw_unit(draw: &Draw, idx: usize, unit: &Unit) {
    ...
    // // TODO: https://stackoverflow.com/questions/72699928/nannou-how-to-draw-a-pie-part-of-an-ellipse
    // draw.ellipse()
    //     .no_fill()
    //     .stroke_color(unit.color)
    //     .stroke_weight(LINE_SIZE)
    //     .caps_round()
    //     .radius(UNIT_SIZE as f32 / 2.0)
    //     .x_y(x_position, arc_start.y + UNIT_SIZE as f32 / 2.0)
    //     .finish();
